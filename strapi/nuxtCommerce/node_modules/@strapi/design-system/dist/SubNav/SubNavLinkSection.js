...
import h from "@strapi/icons/CarretDown";
...
`, l = ({ label: t, children: p, id: s }) => {
  const [r, m] = f(!0), d = y("subnav-list", s), c = () => {
    m((n) => !n);
  };
  return /* @__PURE__ */ e.createElement(i, null, /* @__PURE__ */ e.createElement(k, {
    paddingLeft: 7,
    paddingTop: 2,
    paddingBottom: 2,
    paddingRight: 4
  ...
  }, t))))), r && /* @__PURE__ */ e.createElement("ul", {
    id: d
  }, g.map(p, (n, u) => /* @__PURE__ */ e.createElement("li", {
    key: u
  }, n))));
};
l.defaultProps = {

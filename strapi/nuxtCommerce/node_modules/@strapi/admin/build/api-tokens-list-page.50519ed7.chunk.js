"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[8056],{83782:(Be,O,s)=>{s.r(O),s.d(O,{default:()=>Se});var n=s(32735),r=s(88425),L=s(83983),h=s(5636),b=s(84968),D=s(5141),G=s(33348),Y=s.n(G),J=s(28356),K=s(17e3),X=s(27649),q=s(41415),S=s(19406),I=s(17247);const _=[{name:"name",key:"name",metadatas:{label:{id:"Settings.apiTokens.ListView.headers.name",defaultMessage:"Name"},sortable:!0}},{name:"description",key:"description",metadatas:{label:{id:"Settings.apiTokens.ListView.headers.description",defaultMessage:"Description"},sortable:!1}},{name:"createdAt",key:"createdAt",metadatas:{label:{id:"Settings.apiTokens.ListView.headers.createdAt",defaultMessage:"Created at"},sortable:!1}},{name:"lastUsedAt",key:"lastUsedAt",metadatas:{label:{id:"Settings.apiTokens.ListView.headers.lastUsedAt",defaultMessage:"Last used"},sortable:!1}}];var ee=s(60216),o=s.n(ee),T=s(88860),te=s(3594),ne=s(29005),g=s(66735),ae=s(36320),se=s(4038),oe=s(50563),re=s(62345),le=Object.defineProperty,M=Object.getOwnPropertySymbols,ie=Object.prototype.hasOwnProperty,ce=Object.prototype.propertyIsEnumerable,R=(a,e,t)=>e in a?le(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,de=(a,e)=>{for(var t in e||(e={}))ie.call(e,t)&&R(a,t,e[t]);if(M)for(var t of M(e))ce.call(e,t)&&R(a,t,e[t]);return a};const N=({tokenName:a,onClickDelete:e})=>{const{formatMessage:t}=(0,h.useIntl)(),{trackUsage:u}=(0,r.useTracking)();return n.createElement(re.x,de({paddingLeft:1},r.stopPropagation),n.createElement(oe.h,{onClick:()=>{u("willDeleteToken"),e()},label:t({id:"global.delete-target",defaultMessage:"Delete {target}"},{target:`${a}`}),name:"delete",noBorder:!0,icon:n.createElement(se.default,null)}))};N.propTypes={tokenName:o().string.isRequired,onClickDelete:o().func.isRequired};const ue=N;var me=s(68625),pe=s(83292);const fe={edit:{id:"app.component.table.edit",defaultMessage:"Edit {target}"},read:{id:"app.component.table.read",defaultMessage:"Read {target}"}},ye=(0,pe.default)(r.Link)`
  svg {
    path {

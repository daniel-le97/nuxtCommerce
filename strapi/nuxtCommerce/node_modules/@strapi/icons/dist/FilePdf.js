...
var m = (l, c, e) => c in l ? i(l, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : l[c] = e, h = (l, c) => {
  for (var e in c || (c = {}))
    n.call(c, e) && m(l, e, c[e]);
  if (t)
    for (var e of t(c))
      v.call(c, e) && m(l, e, c[e]);
  return l;
};
import * as a from "react";
function o(l) {
  return /* @__PURE__ */ a.createElement("svg", h({
    width: "1em",
    height: "1em",
    viewBox: "0 0 24 33",
    fill: "none",
